...
public class ShinjukunisiActivity extends AppCompatActivity {
    ...
    DatabaseReference mKotakibashiNinzuRef = mRootRef.child("小滝橋通店");
    ...
    public void map(View v){
        Intent intent= new Intent(Intent.ACTION_VIEW,Uri.parse("geo:0,0?q=ラーメン二郎小滝橋通店"));
    ...
    protected void onStart() {
        ...
        mKotakibashiNinzuRef.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        mButtonGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mKotakibashiNinzuRef.setValue(timeText + "現在\n" + "待ち人数は" + mNinzuText + "人");
            }
        });
